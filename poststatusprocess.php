        ...
        <div class="container">
            <form style="max-width: 600px;">
                ...
                <div class="d-grid gap-2 d-md-block">
                    <a class="btn btn-success" role="button" href="./poststatusform.php">Return</a>
                    <a class="btn btn-primary float-end" role="button" href="./searchstatusform.php">Search Post</a>
                </div>
