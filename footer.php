        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 item text">
                    ...
                    <p>The aim of this assignment is to create a diary system for a social networking site. This system will allow users to post their status and save it to a database table. These posted status details can also be retrieved using text matching
                        and all matched status reports can be viewed in the order they are posted.<br></p>
                </div>
                <div class="col item social">
                    <a href="https://github.com/MiguelEmmara-ai" target="_blank"><i class="icon ion-social-github"></i></a>
                </div>
            </div>
